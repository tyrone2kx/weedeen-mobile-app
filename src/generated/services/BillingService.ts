...
export class BillingService {
     ...
     * @throws ApiError
     */
    public static billingControllerFindAllPlans(): CancelablePromise<Array<Plan>> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/billing/plans',
        });
     ...
     * @throws ApiError
     */
    public static billingControllerGetAllPaymentInformation(): CancelablePromise<Array<PaymentInformation>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static billingControllerGetAllBanksFromPaystack(): CancelablePromise<Array<BankDto>> {
        return __request(OpenAPI, {
            method: 'GET',
